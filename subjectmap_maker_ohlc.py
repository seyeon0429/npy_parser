...
class HistoricalData(object):
    ...
    def save_ohlcvt_atr_l1(self):
        ...
        for d, data_dir in enumerate(self.data_dirs):
            ...
            for n, sym in enumerate(self.securities):
                ...
                if os.path.exists(save_dir_ohlcvt_atr_l1+'.npy'):
                    print(f'\t\t{sym} OHLCVT_ATR L1 file exists!')
                    skip_ohlcvt_atr = True
        ...
        print(f'\n\nCreated {ohlcvt_atr_count} OHLCVT_ATR_L1 npy files.\n\n')

    def save_wBollinger(self):
        # subject_map = []
        ohlcvt_atr_count = 0
        ...
        for d, data_dir in enumerate(self.data_dirs):
            ...
            for n, sym in enumerate(self.securities):
                ...
                if os.path.exists(save_dir_ohlcvt_atr+'.npy'):
                    print(f'\t\t{sym} OHLCVT_ATR_bollinger_{sma_window}_{std_mp_constant} file exists!')
                    skip_ohlcvt_atr = True
